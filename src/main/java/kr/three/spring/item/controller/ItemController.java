package kr.three.spring.item.controller;
...
import kr.three.spring.item.service.ItemService;
...
public class ItemController {
	...
	public String itemNew
		...
		try {
			// Controller에서 Error 처리 (try-catch)
	...
	public String itemDetail(@PathVariable("itemId") Long itemId, Model model) {
		try {
			...
			model.addAttribute("itemFormDto", new ItemFormDto()); // get empty object
			return "item/itemForm";
		}
